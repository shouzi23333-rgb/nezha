...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "appSettings.configFile": "Config File",
    "appSettings.configFileMissing": "Config file does not exist yet. Edit to create it.",
    ...
    "theme.themeHint": "Controls the color theme used by the Nezha interface.",
  ...
  zh: {
    ...
    "appSettings.configFileMissing": "配置文件还不存在，点击编辑后可创建。",
    ...
    "theme.themeHint": "控制 Nezha 界面使用的颜色主题。",
